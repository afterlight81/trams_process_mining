...
ONGOING_ISSUES_FILEPATH = '~/process_mining/announcements/ongoing_issues.csv'
ONGOING_ISSUES_FILE_HEADER = 'tram_line,start_date,estimated_end_date'
RESULT_FILEPATH = '~/process_mining/prepared_data/tram_issues_from_announcements.csv'
CONSECUTIVELY_OMITTED_EMPTY_FILES_AMOUNT_FILEPATH = '~/process_mining/announcements/consecutively_omitted_empty_files_amount.txt'
